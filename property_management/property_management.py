...
class real_estate_lead (models.Model):
    ...
    _name = "property_management.real_estate_lead"
    _description = "Lead/Opportunity"
    _order = "priority desc,date_action,id desc"
    _inherit = ['crm.lead']
    
    item_of_interest_id = fields.Many2one('property_management.building_land', string='Item of Interest', ondelete='set null', track_visibility='onchange',
...
class building_land(models.Model):
    '''Building Land'''
    _name = 'property_management.building_land'
    ...
    parent_id = fields.Many2one('property_management.building_land', string = 'The parent land.')
